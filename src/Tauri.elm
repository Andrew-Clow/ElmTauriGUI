...
{-
    ...
    The useful stuff is in the Tauri/ folder, eg Tauri.FS = FileSystem, Tauri.Dialog = user Dialogs

    This module is just types and utitlities for dealing with the useful things.
