// elm-watch hot {"version":"1.1.1","targetName":"My target name","webSocketPort":57007}
"use strict";
(() => {
...
var $author$project$Tauri$Dialog$confirmOptions = F2(
	function (question, options) {
		return A2(
			$lobanov$elm_taskport$TaskPort$call,
			{
				...
				return A2(
					...
					A2(
						...
						A2(
							...
							$elm$core$Task$succeed($author$project$Main$IgnoreTauriFeedback),
							function (source) {
								return A2(
									$elm$core$Task$andThen,
									A2(
									...
									$author$project$Tauri$Dialog$save(
										{
											defaultPath: $elm$core$Maybe$Nothing,
											filters: _List_Nil,
											title: $elm$core$Maybe$Just('File to save?')
										}));
							}),
						$author$project$Tauri$Dialog$openFile(
							{
...
var $author$project$Main$NewCopyFile = {$: 'NewCopyFile'};
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Main$button($author$project$Main$NewCopyFile),
