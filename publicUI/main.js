...
{
	if (region.aV.ai === region.a9.ai)
	{
		return 'on line ' + region.aV.ai;
	}
	return 'on lines ' + region.aV.ai + ' through ' + region.a9.ai;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cF: 'hidden', cm: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cF: 'mozHidden', cm: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cF: 'msHidden', cm: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cF: 'webkitHidden', cm: 'webkitvisibilitychange' }
		: { cF: 'hidden', cm: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cV, request.aY, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bc: fragment, bi: host, bu: path, bw: port_, bz: protocol, bA: query};
	});
...
var $author$project$Main$resultToString = F2(
	function (result, toString) {
		if (!result.$) {
			...
			return {
				Z: 1,
				ab: $lobanov$elm_taskport$TaskPort$errorToString(error)
			};
		}
	});
...
var $lobanov$elm_taskport$TaskPort$JSErrorRecord = F4(
	function (name, message, stackLines, cause) {
		return {a3: cause, I: message, aP: name, bH: stackLines};
	});
...
var $lobanov$elm_taskport$TaskPort$buildHttpCall = F3(
	function (_function, valueDecoder, args) {
		return {
			cc: $elm$http$Http$jsonBody(args),
			be: _List_Nil,
			cV: 'POST',
			bE: $elm$http$Http$stringResolver(
				$lobanov$elm_taskport$TaskPort$resolveResponse(valueDecoder)),
			dK: $elm$core$Maybe$Nothing,
			aY: $lobanov$elm_taskport$TaskPort$buildCallUrl(_function)
		};
	});
...
var $elm$http$Http$task = function (r) {
	return A3(
		...
		{b3: false, cc: r.cc, aF: r.bE, be: r.be, cV: r.cV, dK: r.dK, bK: $elm$core$Maybe$Nothing, aY: r.aY});
};
...
var $lobanov$elm_taskport$TaskPort$call = F2(
	function (details, args) {
		return A2(
			...
			{
				q: details.q,
				r: $lobanov$elm_taskport$TaskPort$DefaultNS(details.r),
				t: details.t
			},
			args);
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'extensions',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, df.aG)),
				_Utils_Tuple2(
				'name',
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'defaultPath',
					A2($author$project$Tauri$Dialog$encodeNothingAsNull, $elm$json$Json$Encode$string, options.av)),
					_Utils_Tuple2(
					'directory',
					$elm$json$Json$Encode$bool(false)),
					_Utils_Tuple2(
					'filters',
					$author$project$Tauri$Dialog$encodeFilters(options.aI)),
					_Utils_Tuple2(
					'multiple',
					$elm$json$Json$Encode$bool(isMultiSelect.R)),
					_Utils_Tuple2(
					'title',
					A2($author$project$Tauri$Dialog$encodeNothingAsNull, $elm$json$Json$Encode$string, options.ac))
				]));
	});
	...
	function (options, toMsg) {
		return A2(
			...
			A2(
				...
				{
					q: $author$project$Tauri$Dialog$encodeFileDialogOptions(
						{R: false}),
					r: 'openDlg',
					t: $elm$json$Json$Decode$maybe($elm$json$Json$Decode$string)
				},
				options));
	});
var $author$project$Tauri$Dialog$Error = 2;
...
var $author$project$Main$IgnoreTauriFeedback = {$: 5};
var $author$project$Main$NoFileSpecified = {$: 7};
				...
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							'title',
							A2($author$project$Tauri$Dialog$encodeNothingAsNull, $elm$json$Json$Encode$string, title)),
							_Utils_Tuple2(
							'type',
							A2($author$project$Tauri$Dialog$encodeNothingAsNull, $author$project$Tauri$Dialog$encodeDialogType, dialogType))
						]))
				]));
	});
	...
	function (question, options, toMsg) {
		return A2(
			...
			A2(
				$lobanov$elm_taskport$TaskPort$call,
				{
					q: $author$project$Tauri$Dialog$encodeMessageDialogOptions(options),
					r: 'askOptions',
					t: A2(
						$elm$json$Json$Decode$map,
						function (bool) {
	...
	function (question, toMsg) {
		return A2(
			...
			A2(
				$lobanov$elm_taskport$TaskPort$call,
				{
					q: $elm$json$Json$Encode$string,
					r: 'message',
					t: $elm$json$Json$Decode$null(0)
				},
				question));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'recursive',
					$elm$json$Json$Encode$bool(options.c7)),
					_Utils_Tuple2(
					'title',
					A2($author$project$Tauri$Dialog$encodeNothingAsNull, $elm$json$Json$Encode$string, options.ac))
				]));
	...
	function (options, toMsg) {
		return A2(
			...
			A2(
				$lobanov$elm_taskport$TaskPort$call,
				{
					q: $author$project$Tauri$Dialog$encodeDirectoryDialogOptions(
						{R: true}),
					r: 'openDlg',
					t: $elm$json$Json$Decode$maybe(
						$elm$json$Json$Decode$list($elm$json$Json$Decode$string))
				},
				options));
	});
		...
		switch (btn) {
			case 1:
				return A3(
					...
					{
						a8: $elm$core$Maybe$Just(2),
						ac: $elm$core$Maybe$Just('Confirm')
					},
			...
			case 0:
				return A3(
					...
					{a8: $elm$core$Maybe$Nothing, ac: $elm$core$Maybe$Nothing},
			...
			case 3:
				return A2(
					$author$project$Tauri$Dialog$openDirectories,
					{
						...
						c7: true,
						ac: $elm$core$Maybe$Just('Please pick a directory or directories')
					},
			...
			case 4:
				return A2(
					$author$project$Tauri$Dialog$openFile,
					{
						...
						ac: $elm$core$Maybe$Just('Please pick a file')
					},
			...
			case 5:
				return A2(
					$author$project$Tauri$Dialog$save,
					{
						...
						ac: $elm$core$Maybe$Just('What do you want me to save it as?')
					},
...
var $author$project$Main$showMaybeList = function (m) {
	if (m.$ === 1) {
		return 'Nothing';
	} else {
		var list = m.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							m: {
								Z: 2,
								ab: $author$project$Main$show(btn)
							}
						}),
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							m: A2($author$project$Main$resultToString, result, $author$project$Main$showMaybe)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				var result = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							m: A2($author$project$Main$resultToString, result, $author$project$Main$showMaybeList)
						}),
					$elm$core$Platform$Cmd$none);
			case 6:
				var result = msg.a;
				...
				return _Utils_Tuple2(
					...
					A2(
						$author$project$Tauri$Dialog$openFile,
						{
							...
							ac: $elm$core$Maybe$Just('Please pick a text file')
						},
						$author$project$Main$GotFilePath));
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							m: A2($author$project$Main$resultToString, fileContents, showFileContents)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$Ask = 0;
var $author$project$Main$Confirm = 1;
var $author$project$Main$Message = 2;
var $author$project$Main$OpenDirectories = 3;
var $author$project$Main$OpenFile = 4;
var $author$project$Main$Pressed = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$ReadTextFile = 6;
var $author$project$Main$Save = 5;
...
var $mdgriffith$elm_ui$Internal$Model$asEl = 2;
var $mdgriffith$elm_ui$Internal$Style$classes = {bV: 'a', aA: 'atv', bX: 'ab', bY: 'cx', bZ: 'cy', b_: 'acb', b$: 'accx', b0: 'accy', b1: 'acr', a1: 'al', a2: 'ar', b2: 'at', aB: 'ah', aC: 'av', b5: 's', b9: 'bh', ca: 'b', cd: 'w7', cf: 'bd', cg: 'bdt', ao: 'bn', ch: 'bs', ap: 'cpe', cn: 'cp', co: 'cpx', cp: 'cpy', G: 'c', ar: 'ctr', as: 'cb', at: 'ccx', H: 'ccy', ag: 'cl', au: 'cr', cs: 'ct', cu: 'cptr', cv: 'ctxt', cC: 'fcs', bb: 'focus-within', cD: 'fs', cE: 'g', aK: 'hbh', aL: 'hc', bg: 'he', aM: 'hf', bh: 'hfp', cG: 'hv', cI: 'ic', cK: 'fr', ax: 'lbl', cM: 'iml', cN: 'imlf', cO: 'imlp', cP: 'implw', cQ: 'it', cR: 'i', bm: 'lnk', _: 'nb', bp: 'notxt', cY: 'ol', c_: 'or', T: 'oq', c2: 'oh', bs: 'pg', bt: 'p', c3: 'ppe', da: 'ui', x: 'r', dc: 'sb', dd: 'sbx', de: 'sby', df: 'sbt', di: 'e', dk: 'cap', dl: 'sev', dt: 'sk', ab: 't', dw: 'tc', dx: 'w8', dy: 'w2', dz: 'w9', dA: 'tj', az: 'tja', dB: 'tl', dC: 'w3', dD: 'w5', dE: 'w4', dF: 'tr', dG: 'w6', dH: 'w1', dI: 'tun', bL: 'ts', W: 'clr', dO: 'u', aZ: 'wc', bQ: 'we', a_: 'wf', bR: 'wfp', a$: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.b5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cE);
...
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.b5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.x);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.b5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.di);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.A)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dm.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dm.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.x) + ('-' + ($elm$core$String$fromInt(pos.cq) + ('-' + ($elm$core$String$fromInt(pos.bP) + ('-' + $elm$core$String$fromInt(pos.bf)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.cX.a) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.cX.b) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.cb) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.dj) + 'px'),
					$elm$core$Maybe$Just(
					$mdgriffith$elm_ui$Internal$Model$formatColor(shadow.cr))
				])));
};
								...
								$mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
									{
										...
										cX: A2(
											...
											A2($elm$core$Tuple$mapFirst, $elm$core$Basics$toFloat, shadow.cX)),
										dj: shadow.dj
									}));
						},
						focus.dh),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b5) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.x) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b5) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b5) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.x) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b5) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ar) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aq: closing, i: _List_Nil, K: _List_Nil, y: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								i: A2(
									$elm$core$List$cons,
									{aq: '\n}', i: _List_Nil, K: props, y: '@supports (' + (prop + (':' + (value + (') {' + parent.y))))},
									rendered.i)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.y + ('{' + (renderValues(rule.K) + (rule.aq + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.x) + (' / ' + ($elm$core$String$fromInt(position.x + position.bf) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cq) + (' / ' + ($elm$core$String$fromInt(position.cq + position.bP) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.x) + ('-' + ($elm$core$String$fromInt(position.cq) + ('-' + ($elm$core$String$fromInt(position.bP) + ('-' + $elm$core$String$fromInt(position.bf)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dk + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.ab + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dk + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.ab)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bf: height / size, dj: size, bN: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cl, adjustment.b8, adjustment.cw, adjustment.cU]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.b5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.di))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b5, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.H, $mdgriffith$elm_ui$Internal$Style$classes.b1])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b5, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.H, $mdgriffith$elm_ui$Internal$Style$classes.b$])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b5, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.b0])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b5, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.b_])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.b5 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ab + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aZ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aL)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.b5 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ab + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aM)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.bV]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ca]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.c_]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.cY]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.cK]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.b9]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a1);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a2);
		default:
...
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b2);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bX);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bZ);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.b5 + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.x + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.at + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.H + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.df + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bp)))))),
						A2(
							$elm$core$List$cons,
	...
	return $elm$core$String$concat(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.cX.a) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.cX.b) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.cb) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.dj) + 'px',
				$mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.cr)
			]));
};
var $mdgriffith$elm_ui$Internal$Flag$shadows = $mdgriffith$elm_ui$Internal$Flag$flag(19);
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {cb: almostShade.cb, cr: almostShade.cr, bk: false, cX: almostShade.cX, dj: almostShade.dj};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A3($mdgriffith$elm_ui$Element$rgb255, 200, 255, 200)),
					$mdgriffith$elm_ui$Element$Border$rounded(10),
					$mdgriffith$elm_ui$Element$padding(8),
					$mdgriffith$elm_ui$Element$Border$shadow(
					{
						cb: 2,
						cr: A3($mdgriffith$elm_ui$Element$rgb255, 150, 244, 150),
						cX: _Utils_Tuple2(2, 2),
						dj: 2
					})
				]),
			{
				cS: $mdgriffith$elm_ui$Element$text(string),
				cZ: $elm$core$Maybe$Just(msg)
			});
	});
...
var $mdgriffith$elm_ui$Internal$Model$focusDefaultStyle = {
	...
	dh: $elm$core$Maybe$Just(
		{
			cb: 0,
			cr: A4($mdgriffith$elm_ui$Internal$Model$Rgba, 155 / 255, 203 / 255, 1, 1),
			cX: _Utils_Tuple2(0, 0),
			dj: 3
		})
};
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cC: $elm$core$Maybe$Nothing, cG: $elm$core$Maybe$Nothing, cW: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.da, $mdgriffith$elm_ui$Internal$Style$classes.b5, $mdgriffith$elm_ui$Internal$Style$classes.di]))),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('Hello! This is just to experiment with using Tauri with elm.'),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
						...
						[
							...
							_List_fromArray(
								[
									...
									'Ask.',
									$author$project$Main$Pressed(0)),
									A2(
									$author$project$Main$button,
									'Confirm',
									$author$project$Main$Pressed(1)),
									A2(
									$author$project$Main$button,
									'Message',
									$author$project$Main$Pressed(2)),
									A2(
									$author$project$Main$button,
									'Open Directories',
									$author$project$Main$Pressed(3)),
									A2(
									$author$project$Main$button,
									'Open File',
									$author$project$Main$Pressed(4)),
									A2(
									$author$project$Main$button,
									'Save',
									$author$project$Main$Pressed(5))
								])),
					...
					$mdgriffith$elm_ui$Element$text(model.m.ab))
				])));
};
